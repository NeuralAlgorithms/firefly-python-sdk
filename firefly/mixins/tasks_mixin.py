...
class TasksMixin(abc.ABC):
    ...
    def train(self, name, estimators: List[Estimator], target_metric: TargetMetric,
              dataset_id, splitting_strategy: SplittingStrategy, notes=None, ensemble_size=None,
              max_models_num=None,
              single_model_timeout=None,
              pipeline: List[Pipeline] = None, prediction_latency=None,
              interpretability_level: InterpretabilityLevel = None, timeout=None,
              cost_matrix_weights=None, train_size=None, test_size=None, validation_size=None, fold_size=None,
              n_folds=None,
              horizon=None, validation_strategy: ValidationStrategy = None, cv_strategy: CVStrategy = None,
              forecast_horizon=None, model_life_time=None,
        ...
        task_config = {
            ...
            'target_metric': extract_value_from_enum(target_metric),
            'splitting_strategy': extract_value_from_enum(splitting_strategy),
            'ensemble_size': ensemble_size,
            'max_models_num': max_models_num,
            'single_model_timeout': single_model_timeout,
            'pipeline': [p.value for p in pipeline],
            'prediction_latency': prediction_latency,
            'interpretability_level': extract_value_from_enum(interpretability_level),
            'timeout': timeout,
            'cost_matrix_weights': cost_matrix_weights,
            'train_size': train_size,
            'test_size': test_size,
            'validation_size': validation_size,
            'cv_strategy': extract_value_from_enum(cv_strategy),
            'n_folds': n_folds,
            'horizon': horizon,
            'forecast_horizon': forecast_horizon,
            'model_life_time': model_life_time,
            'fold_size': fold_size,
            'validation_strategy': extract_value_from_enum(validation_strategy),
            'notes': notes,
